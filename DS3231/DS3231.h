...
#define AL_ONCE_SECOND 0
#define AL_SECOND_MATCH 1
#define AL_MIN_SEC_MATCH 2
#define AL_HR_MIN_SEC_MATCH 3
#define AL_DATE_HR_MIN_SEC_MATCH 4
#define AL_DAY_HR_MIN_SEC_MATCH 5
...
class DS3231
{
	public:
		...
		void turnOnA1();
		void turnOffA1();
		void setModeA1(uint8_t mode);
		void setTimeA1(uint8_t day_date, bool day, uint8_t hour, uint8_t min, uint8_t sec); //use -1 if day_date not needed
		void resetA1();
		bool read_A1F();
	...
	private:
		...
		/*encodes the value as described in datasheet <7:4> contain //10; <3:0> contain %10*/
